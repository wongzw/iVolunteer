<template>
    <div class="card-holder">
        <div class="current-events">
            <h1 style="color:#FF734C; font-family: 'Mulish'; font-weight: 700 ">Current Events</h1>
            <div class="ant-button">
                <a-button type="primary" size="large" class="orange" @click="eventCreation">
...
<script>
    import OrgEventCard from '@/components/OrgEventCard.vue'
